...
welcome_animation() {
    ...
    echo -e "${CYAN}"
    echo -e "  
    echo  "            _   _      _      ____     ___   __        __   ____   ____       _      _____   _____ 
    echo  "           / ___|  | | | |    / \    |  _ \   / _ \  \ \      / /  / ___| |  _ \     / \    |  ___| |_   _|
    echo  "           \___ \  | |_| |   / _ \   | | | | | | | |  \ \ /\ / /  | |     | |_) |   / _ \   | |_      | |  
    echo  "            ___) | |  _  |  / ___ \  | |_| | | |_| |   \ V  V /   | |___  |  _ <   / ___ \  |  _|     | |  
    echo  "            |____/  |_| |_| /_/   \_\ |____/   \___/     \_/\_/     \____| |_| \_\ /_/   \_\ |_|       |_|  
    echo  "   
    echo  "                                POWERED BY ShadowCraftMC${NC}"
    echo  "   
    echo  "   
    echo -e "${NC}"
    echo -e "${CYAN}                 
...
install_blueprint() {
    ...
    print_header "DOWNLOADING BLUEPRINT HOSTING"
...
show_menu() {
    ...
    echo -e "${CYAN}                 BY ShadowCraftMC                  ${NC}"
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e ""
    echo -e "${WHITE}╔═══════════════════════════════════════════════╗${NC}"
    ...
    echo -e "${WHITE}║   ${GREEN}2)${NC} ${CYAN}Reinstall Blueprint${NC}                ${WHITE}║${NC}"
